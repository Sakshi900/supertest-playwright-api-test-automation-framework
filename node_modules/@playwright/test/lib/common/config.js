...
class FullConfigInternal {
  ...
  constructor(configDir, configFile, config, configCLIOverrides) {
    ...
    this.config = {
      ...
      reporter: takeFirst(configCLIOverrides.reporter ? toReporters(configCLIOverrides.reporter) : undefined, resolveReporters(config.reporter, configDir), [[defaultReporter]]),
