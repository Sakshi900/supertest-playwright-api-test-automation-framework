...
const version = 13;
const DEFAULT_CACHE_DIR_WIN32 = _path.default.join(_os.default.tmpdir(), `playwright-transform-cache`);
const DEFAULT_CACHE_DIR_POSIX = _path.default.join(_os.default.tmpdir(), `playwright-transform-cache-` + (0, _util.sanitizeForFilePath)(_os.default.userInfo().username));
