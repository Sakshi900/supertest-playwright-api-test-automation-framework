...
exports.kDefaultConfigFiles = exports.defineConfig = exports.ConfigLoader = void 0;
...
class ConfigLoader {
  ...
  static async deserialize(data) {
    ...
    (0, _babelBundle.setBabelPlugins)(data.babelTransformPlugins);
  ...
  async loadConfigFile(file, ignoreProjectDependencies = false) {
    ...
    if (ignoreProjectDependencies) {
      for (const project of fullConfig.projects) project.deps = [];
    }
