...
class ExpectMetaInfoProxyHandler {
  ...
  get(target, matcherName, receiver) {
    ...
    return (...args) => {
      ...
      if (generateTraceEvent) testInfo._traceEvents.push((0, _utils.createBeforeActionTraceEventForExpect)(`expect@${callId}`, defaultTitle, wallTime, args[0], stackFrames));
